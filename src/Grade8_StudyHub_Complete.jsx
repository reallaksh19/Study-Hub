...
function getSubjectDashboardIcon(subject) {
  ...
  if (route === '#/student') {
    return (
      <div className="p-8 max-w-5xl mx-auto">
        <div className="mb-4">
          <button onClick={() => { window.location.hash = '#/'; }} className="inline-flex items-center px-3 py-1.5 rounded border border-gray-300 text-sm font-semibold text-gray-700 hover:bg-gray-50">
            ← Back
          </button>
        </div>
            ...
            return (
              <div key={subject.id} className="border p-6 rounded-xl shadow-sm hover:shadow-md bg-white">
                <div className="flex items-center mb-2">
                  <div
                    className="w-10 h-10 rounded-full flex items-center justify-center text-white text-lg shadow-sm mr-3"
                    style={{ backgroundColor: subject.color || '#4f46e5' }}
                  >
                    {getSubjectDashboardIcon(subject)}
                  </div>
