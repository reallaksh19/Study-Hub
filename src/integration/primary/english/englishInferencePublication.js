...
<body>
  <main>
    <section class="card" aria-labelledby="page-title">
      ...
      <div id="return-content">
        ...
        <div class="field"><label for="answer">1. My answer</label><textarea id="answer" autocomplete="off" placeholder="I think..."></textarea></div>
        <div class="field"><label for="clue">2. My text clue <span class="cue">Use words from the text that helped you.</span></label><textarea id="clue" autocomplete="off" placeholder="The clue is..."></textarea></div>
        <div class="field"><label for="connection">3. My connection <span class="cue">Explain how the clue supports your answer.</span></label><textarea id="connection" autocomplete="off" placeholder="This clue supports my answer because..."></textarea></div>
        <div class="actions"><button id="finish" type="button">I finished all 3 parts ✓</button><a class="button" href="../../">Back to Study-Hub</a></div>
        <div id="done" class="done" role="status"><strong>Return task complete.</strong><br />You gave an answer, a text clue and the connection. Keep this work for the teacher/runtime check.</div>
        <div class="later"><strong>Later retrieval:</strong> a fresh inference check belongs ${earliestDays}–${latestDays} days later. Its status stays <code>NOT_YET_TESTED</code> until that later check happens.</div>
  ...
  <script>
    (() => {
      ...
      if (mission !== expected) { content.style.display = 'none'; error.style.display = 'block'; return; }
